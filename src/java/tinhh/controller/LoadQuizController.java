...
public class LoadQuizController extends HttpServlet {
    ...
    private static final String ERROR="error.jsp";
        private static final Logger LOGGER = Logger.getLogger(LoadQuizController.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<QuizDTO> quizDTOs= quizDAO.getQuizList(account.getEmail());
            session.setAttribute("QUIZLIST", quizDTOs);
            url=SUCCESS;
        } catch (Exception e) {
            log("Error at LoadQuizController: " + e.getMessage());
            LOGGER.error("Error at LoadQuizController: " + e.getMessage());
        }finally{
